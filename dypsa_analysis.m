function varargout = dypsa_analysis(varargin)
% DYPSA_ANALYSIS MATLAB code for dypsa_analysis.fig
%      DYPSA_ANALYSIS, by itself, creates a new DYPSA_ANALYSIS or raises the existing
%      singleton*.
%
%      H = DYPSA_ANALYSIS returns the handle to a new DYPSA_ANALYSIS or the handle to
%      the existing singleton*.
%
%      DYPSA_ANALYSIS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DYPSA_ANALYSIS.M with the given input arguments.
%
%      DYPSA_ANALYSIS('Property','Value',...) creates a new DYPSA_ANALYSIS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dypsa_analysis_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dypsa_analysis_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dypsa_analysis

% Last Modified by GUIDE v2.5 19-Nov-2017 17:02:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dypsa_analysis_OpeningFcn, ...
                   'gui_OutputFcn',  @dypsa_analysis_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dypsa_analysis is made visible.
function dypsa_analysis_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dypsa_analysis (see VARARGIN)

% Choose default command line output for dypsa_analysis
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dypsa_analysis wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dypsa_analysis_OutputFcn(hObject, eventdata, handles) 

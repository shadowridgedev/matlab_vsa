...
function varargout = dypsa_testbed(varargin)
% DYPSA_TESTBED MATLAB code for dypsa_testbed.fig
%      DYPSA_TESTBED, by itself, creates a new DYPSA_TESTBED or raises the existing
%      singleton*.
%
%      H = DYPSA_TESTBED returns the handle to a new DYPSA_TESTBED or the handle to
%      the existing singleton*.
%
%      DYPSA_TESTBED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DYPSA_TESTBED.M with the given input arguments.
%
%      DYPSA_TESTBED('Property','Value',...) creates a new DYPSA_TESTBED or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dypsa_testbed_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dypsa_testbed_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dypsa_testbed

% Last Modified by GUIDE v2.5 19-Nov-2017 18:56:54

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dypsa_testbed_OpeningFcn, ...
                   'gui_OutputFcn',  @dypsa_testbed_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dypsa_testbed is made visible.
function dypsa_testbed_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dypsa_testbed (see VARARGIN)

% Choose default command line output for dypsa_testbed
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dypsa_testbed wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dypsa_testbed_OutputFcn(hObject, eventdata, handles) 
